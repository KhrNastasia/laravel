<x-app-layout>
    <div class="max-w-7xl w-screen">
        <div class='bg-cover w-screen h-[calc(100vh-64px)]'
            ...
            <section class="text-white body-font">
                ...
                <div class="container px-5 py-44 mx-auto w-full">
                    ...
                    <button
                        class="flex mx-auto mt-16 text-green-600 bg-white border-0 py-2 px-8 focus:outline-none hover:font-medium rounded text-lg">
                        Start shopping
                    </button>
                </div>
            </section>
